...
(normal_command
  ...
  (#match? @keyword.repeat "\\\\s^(continue|break)$"))

(normal_command
  (identifier) @keyword.return
  (#match? @keyword.return "\\\\s^return$"))
...
;
((argument) @boolean
  (#match? @boolean "\\\\s^(1|on|yes|true|y|0|off|no|false|n|ignore|notfound|.*-notfound)$"))
